...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">doa-commerce documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-482005120a5b6396a7d2194b70c4bdb9"' : 'data-target="#xs-components-links-module-AppModule-482005120a5b6396a7d2194b70c4bdb9"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-482005120a5b6396a7d2194b70c4bdb9"' :
                                            'id="xs-components-links-module-AppModule-482005120a5b6396a7d2194b70c4bdb9"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/DoeComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">DoeComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/ListaProdutoCategoriaComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ListaProdutoCategoriaComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/ProdutoCategoriaComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ProdutoCategoriaComponent</a>
                                            </li>
                                            <li class="link">
